...
//Or     CLK -> 9 , DAT -> 33, Reset -> 32

virtuabotixRTC myRTC(9, 33, 32); //If you change the wiring change the pins here also
...
void setup() {
 ...
 //myRTC.setDS1302Time(50, 35, 22, 1, 24, 2, 2020);  //Here you write your actual time/date as shown above 
